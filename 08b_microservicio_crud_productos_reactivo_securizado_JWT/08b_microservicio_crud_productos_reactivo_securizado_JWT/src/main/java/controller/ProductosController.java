...
public class ProductosController {
	...
	public ResponseEntity<Flux<Producto>> productosCategoria(@PathVariable String categoria){
		return new ResponseEntity<>(productosService.productosCategoria(categoria),HttpStatus.OK);
	}
	
	@GetMapping(value="producto")
	public ResponseEntity<Mono<Producto>> productoCodigo(@RequestParam int cod) {
	...
	public Mono<ResponseEntity<Producto>> eliminarProducto(@RequestParam int cod) {
	...
	public Mono<ResponseEntity<Producto>> actualizarProducto(@RequestParam int cod,@RequestParam double precio) {
